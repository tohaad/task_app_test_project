...
class UserLoginAPIView(APIView):
    ...
    @extend_schema(request=UserLoginSerializer, responses={200: UserLoginResponseSerializer})
    def post(self, request, *_args, **_kwargs):
...
class UserLogoutAPIView(APIView):
    ...
    @extend_schema(request=EmptyBodySerializer, responses={200: EmptyBodySerializer})
    def post(self, request, *_args, **_kwargs):
